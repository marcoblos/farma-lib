              ...
              <View style={styles.container}>
                ...
                <View style={{flexDirection: 'row'}}>
                  <View style={{flex: 2, paddingRight: 15}}>
                    <FaInput label='CEP' ref='cep' value={this.state.cep} onChange={(text) => this.setState({cep: text})} required={true} showErrors={this.state.showErrors} />
                  </View>
                ...
                <View style={{flexDirection: 'row'}}>
                  <View style={{flex: 2, paddingRight: 15}}>
                    <FaInput label='Rua' ref='rua' value={this.state.rua} onChange={(text) => this.setState({rua: text})} required={true} showErrors={this.state.showErrors} />
                  </View>
                  <View style={{flex: 1, paddingLeft: 15}}>
                    <FaInput label='Número' ref='numero' value={this.state.numero} onChange={(text) => this.setState({numero: text})} required={true} showErrors={this.state.showErrors} />
                  </View>
                </View>

                <FaInput label='Cidade' ref='cidade' value={this.state.cidade} onChange={(text) => this.setState({cidade: text})} required={true} showErrors={this.state.showErrors} />

                <FaInput label='Estado' ref='uf' value={this.state.uf} onChange={(text) => this.setState({uf: text})} required={true} showErrors={this.state.showErrors} />

                <FaInput label='Complemento' ref='complemento' value={this.state.complemento} onChange={(text) => this.setState({complemento: text})} required={true} showErrors={this.state.showErrors} />
