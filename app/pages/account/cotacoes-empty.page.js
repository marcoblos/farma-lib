    ...
    return (
      ...
      <ScrollView>
        ...
        <View style={{backgroundColor: 'white', padding: 20}}>
          ...
          <FaPageTitle paddingBottom={20} title='Pedido nº 29' subTitle='Aguardando resposta da farmácia.' />

          <View style={{flexDirection: 'row'}}>
            <View style={{flex: 2}}>
              <FaInfo icon='event' last={true} label='Data do pedido' value='30/10/2016' />
            </View>
            <View style={{flex: 1}}>
              <FaInfo icon='access-time' label='Horário' last={true} value='22:10' />
            </View>
          </View>
          ...
          <View>
            ...
            <View style={{paddingTop: 30}}>
              <FaButton label='CANCELAR PEDIDO' type='danger' size='md' onPress={() => this._cancelarPedido() } />
            </View>
          </View>
