...
export class CotacoesAndamentoPage extends Component {
  constructor(props) {
    super(props)
    ...
    return (
      <ViewContainer>
        ...
        <ScrollView>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', paddingLeft: 15, backgroundColor: '#6dbeef' }}>
            <Icon name="restore" style={{ fontSize: 45, color: 'rgba(255,255,255,0.7)' }} />
            <View style={{ flex: 1, padding: 15, paddingTop: 20, paddingBottom: 20, color: 'white' }}>
              <Text style={{ color: 'white' }}>Aguardando a farmácia processar o pedido.</Text>
            </View>
          </View>
          ...
          <View style={{ backgroundColor: 'white', padding: 20 }}>
            ...
            <View>
              ...
              <View style={{ paddingTop: 30 }}>
                <FaButton label="CANCELAR PEDIDO" type="ternary" size="md" onPress={() => this.setModalVisible(true)} />
              </View>
            </View>
